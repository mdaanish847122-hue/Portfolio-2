...
export const projects = [
  { id: 1, title: "AI Portfolio", description: "Modern portfolio with Next.js and Tailwind", tech: ["Next.js", "Tailwind"], link: "#", github: "#", image: "", tag: "Web App", category: "GenAI", featured: true },
  { id: 2, title: "GenAI Chat App", description: "Chat app using LLM APIs and RAG", tech: ["React", "OpenAI"], link: "#", github: "#", image: "", tag: "GenAI", category: "GenAI", featured: true }
];
...
EOFgit add lib/data.ts
git commit -m "fix: add tag field"
git push
cat > lib/data.ts << 'EOF'
export const profile = {
  name: "MD Aanish",
